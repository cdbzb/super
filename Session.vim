...
exe 'vert 3resize ' . ((&columns * 170 + 126) / 253)
exe '4resize ' . ((&lines * 5 + 27) / 55)
exe 'vert 4resize ' . ((&columns * 170 + 126) / 253)
exe 'vert 5resize ' . ((&columns * 82 + 126) / 253)
argglobal
setlocal fdm=manual
setlocal fde=FoldParts(v:lnum)
setlocal fmr={{{,}}}
